...
public class Runner extends BaseDriver {
    ...
    public void logoToHomePage() {
        ...
        List<WebElement> buttons = Arrays.asList(element.termsofUseBtn, element.cookiePolicyBtn, element.privacyPolicyBtn);

        List<WebElement> controls = Arrays.asList(element.termsofUseControl, element.cookiePolicyControl, element.privacyPolicyControl);
